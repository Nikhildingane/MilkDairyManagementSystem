...
Public Class CrystalReportCustomer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Milk_Dairy_Management_System.CrystalReportCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportCustomer = New CrystalReportCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function
